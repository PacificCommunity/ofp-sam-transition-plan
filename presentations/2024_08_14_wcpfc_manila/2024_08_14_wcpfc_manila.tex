...
\ifthenelse{\equal{\details}{1}}{
  \begin{frame}{Stock assessment software}
    ...
    \begin{itemize}
      ...
      \item[-] {\bf Gadget} has many features relevant for tuna
      assessments\\[3ex]
      \item[-] {\bf Casal} has many features relevant for tuna
      assessments\\[4ex]
    \end{itemize}
...
\ifthenelse{\equal{\details}{1}}{
  \begin{frame}{Stock assessment software}
    ...
    \begin{itemize}
      ...
      assessments\\[3ex]
      \item[-] {\bf ALSCL} is a state-space model that fits length comps,
      currently no catches\\[3ex]
      \item[-] {\bf WHAM$\,$\raisebox{0.15ex}{+}$\,$Length} is a state-space
      that fits length comps, currently single-region\\[3ex]
      \item[-] {\bf SAM$\,$\raisebox{0.15ex}{+}$\,$Length} is an early
      exploration of extending SAM to fit length comps\\[3ex]
      \item[-] {\bf Stock Synthesis$\,$\raisebox{0.15ex}{+}$\,$Enhanced Tags} is
      a proposed enhancement of the tag module\\[2ex]
    \end{itemize}
  \end{frame}
}{}
...
\ifthenelse{\equal{\details}{1}}{
  \begin{frame}{Stock Synthesis}
    ...
    \begin{itemize}
      ...
      Synthesis\\[1ex]
      \item[+] facilitates collaboration between the tuna RFMOs, including
      future development\\[1ex]
      \item[+] shortens training time for new SPC staff, makes skills and
      experience transferable\\[1ex]
      \item[+] large user community, relevant for peer reviews and
      discussing technical decisions\\[1ex]
      \item[+] exceptionally complete suite of tools, diagnostics, automated
      plots and tables\\[1ex]
    \end{itemize}
  \end{frame}
}{}
...
\ifthenelse{\equal{\details}{1}}{
  \begin{frame}{Possible tasks for SPC to prioritize}
    ...
    \begin{enumerate}\setcounter{enumi}{5}
      ...
      \comment{\gray Anders Nielsen (DTU), Colin Millar (ICES), and Arni
        Magnusson (SPC)}\\[1.5ex]
    \end{enumerate}
  \end{frame}
}{}
...
\begin{frame}{Timeline}
  \begin{itemize}
    \item[] 2024 \quad Scoping project launched (Feb)\\[3ex]
    \item[] 2024 \quad Pre-assessment workshop (Mar)\\[3ex]
    \item[] 2024 \quad International expert meeting (May--Jun)\\[3ex]
    \item[] 2024 \quad Developer workshop (Aug--Sep)\\[3ex]
  \end{itemize}
\end{frame}
...
\ifthenelse{\equal{\details}{1}}{
  \begin{frame}{Recommendations from 2024 international expert meeting}
    \begin{enumerate}
      ...
      \comment{\gray explicitly track the population by age and length, if not
        too costly}\\[1ex]
