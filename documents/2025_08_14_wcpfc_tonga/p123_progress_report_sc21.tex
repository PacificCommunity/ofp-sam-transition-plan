...
The FIMS project aims for a modular and flexible design paradigm, allowing
scientists to choose and link together code modules to produce a stock
...
could potentially provide a variety of features, both to add basic extensions
and to introduce fundamental changes in the model structure. Possible examples
of add-on FIMS modules might include:
