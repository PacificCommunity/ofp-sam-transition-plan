...
\subsubsection{Review of existing software}
...
\section{Other project activitites}
...
\subsection{FIMS workshop to explore linking modules}
...
\subsection{Tuna RFMO workshop to review Stock Synthesis approaches and
  techniques}

used in Stock Synthesis tuna assessment models

\subsection{Project proposal for development of DTU spatio-temporal full
  assessment model}

\subsection{Project proposal for development of tuna-specific FIMS modules}
