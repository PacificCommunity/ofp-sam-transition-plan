...
\begin{enumerate}
  ...
  extended.\\[-4.5ex]
  \item Reach out to and initiate collaboration with model developers.\\[-3ex]
\end{enumerate}
...
\begin{enumerate}\setcounter{enumi}{7}
  ...
  billfish\\
  stock assessments to new software platforms.\\[-3ex]
\end{enumerate}
...
\begin{itemize}
  ...
  before considering extensions to the model further, see ALSCL $\!+\!$ Fleets
  below.
\end{itemize}
...
\begin{itemize}
  \item \textit{Stock Synthesis $\!+\!$ Enhanced Tags} is a potential software
  ...
  \item \textit{WHAM $\!+\!$ Length} is a recent software development (Correa et
  al. 2023) extending the state-space stock assessment software WHAM (Stock and
  ...
  \item \textit{ALSCL $\!+\!$ Fleets} is a potential software development
  extending the ALSCL model to address the primary shortcomings of the current
  ALSCL model as candidate software for tuna stock assessments. A possible
  avenue of collaborative development is to explore the possibility of adding
  commercial catches and fleets as software features.
...
\begin{enumerate}\setcounter{enumi}{5}
  ...
  \item SAM $\!+\!$ Length. Scientists involved could include Anders Nielsen
  (DTU), Colin Millar (ICES), and Arni Magnusson (SPC).
\end{enumerate}
