...
\subsubsection{TOR 10. Organize FIMS workshop to explore the technical
  procedures and programming interface involved in producing FIMS modules}

\subsubsection{TOR 11. Support DTU analysis of WCPO skipjack tagging data}

\subsubsection{TOR 12. Summarize tuna RFMO feedback from scoping project
  questionnaire}

\subsubsection{TOR 13. Develop Gadget model for single-area yellowfin dataset}

\subsubsection{TOR 14. Explore the possibility of using the SBT model code as a
  starting point for developing new software for the South Pacific albacore
  assessment}

\subsection{2026 (first half)}

\subsubsection{TOR 15. Organize a workshop reviewing approaches and techniques
  used in Stock Synthesis tuna assessment models}

\subsubsection{TOR 16. Develop Stock Synthesis model for single-area yellowfin
  dataset}

\subsubsection{TOR 17. Prepare project proposal for development of DTU
  spatio-temporal full assessment model}

\subsubsection{TOR 18. Prepare project proposal for development of tuna-specific
  FIMS modules}

\subsubsection{TOR 19. Prepare outline of simulation analysis that could be
