...
The scoping project has identified two streams of development work.
...
(\autoref{fig:dtu-movement}). The prototype model developed during the workshop
...
\begin{figure}[H]
  \centering
  \includegraphics[width=\textwidth]{dtu_movement}
  \caption{Snapshot of a prototype model analyzing a subset of the WCPO skipjack
    tagging data.\label{fig:dtu-movement}}
\end{figure}
