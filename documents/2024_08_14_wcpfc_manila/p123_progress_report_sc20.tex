...
\hyphenation{computational consideration desired assessment future replacement
  ...
  programming relevant RFMOs valuable recommendations expected over-arching
  possible currently simplified}
\begin{document}
...
year, and communications with the FIMS project will continue. An international
expert meeting was conducted in 2024 to seek advice from the scientific
community and to seek collaboration with tuna RFMOs and various research labs.
...
resources to hire SPC staff scientists and/or consultants who will focus 100\%
on model exploration and software development.
...
\begin{itemize}
  \item note that over the next years, MULTIFAN-CL will be phased out as a
  software platform for WCPFC tuna and billfish stock assessments;
  \item note that an international expert meeting was organized in 2024 to seek
  ...
  \item consider recommending collaboration between tuna RFMOs to coordinate and
  strengthen the research and development required for MULTIFAN-CL and Stock
  Synthesis succession plans.
\end{itemize}
