...
\hyphenation{computational consideration desired assessment future replacement
  ...
  scientists succession coordination collaborate consultation}
\begin{document}
...
\begin{enumerate}
  ...
  products that is not used outside of SPC. Since the statistical challenges of
  analyzing tuna data are comparable between the tuna RFMOs, it makes sense to
  coordinate and collaborate in succession plans and new software development.
\end{enumerate}
...
Compared to the other tuna RFMOs, SPC is in a greater urgency of moving the
project forward at a fast pace. Independent of decisions and commitments of the
other tuna RFMOs, the main project would probably require two full-time people
to the project for five years, or until assessments have been transitioned to
the new software.
